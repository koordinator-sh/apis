...
import (
	...
	v1alpha1 "github.com/koordinator-sh/apis/client/listers/config/v1alpha1"
...
func NewClusterColocationProfileInformer(client versioned.Interface, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredClusterColocationProfileInformer(client, resyncPeriod, indexers, nil)
}
...
func (f *clusterColocationProfileInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredClusterColocationProfileInformer(client, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, f.tweakListOptions)
}
