...
func (c *devices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Device, err error) {
...
func (c *devices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DeviceList, err error) {
...
func (c *devices) Create(ctx context.Context, device *v1alpha1.Device, opts v1.CreateOptions) (result *v1alpha1.Device, err error) {
	result = &v1alpha1.Device{}
	err = c.client.Post().
		Resource("devices").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *devices) Update(ctx context.Context, device *v1alpha1.Device, opts v1.UpdateOptions) (result *v1alpha1.Device, err error) {
	result = &v1alpha1.Device{}
	err = c.client.Put().
		Resource("devices").
		Name(device.Name).
...
func (c *devices) UpdateStatus(ctx context.Context, device *v1alpha1.Device, opts v1.UpdateOptions) (result *v1alpha1.Device, err error) {
	result = &v1alpha1.Device{}
	err = c.client.Put().
		Resource("devices").
		Name(device.Name).
...
func (c *devices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Device, err error) {
	result = &v1alpha1.Device{}
