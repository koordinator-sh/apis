...
var podmigrationjobsResource = v1alpha1.SchemeGroupVersion.WithResource("podmigrationjobs")

var podmigrationjobsKind = v1alpha1.SchemeGroupVersion.WithKind("PodMigrationJob")
...
func (c *FakePodMigrationJobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(podmigrationjobsResource, name, opts), &v1alpha1.PodMigrationJob{})
	return err
}
